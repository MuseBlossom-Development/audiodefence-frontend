                  ...
                  <div class="card">
                      <div class="card-body">
                          <div class="invite-content">
                              ...
                              <p>
                                  You will receive up to $30 when they： 1.Buy Crypto 2. Deposit 3. Finish Trading
                                  Tasks
                                  <br/>
                                  <a href="#">Learn more</a >
                              </p>
                  ...
                  <div class="card">
                      <div class="card-body">
                          <div class="invite-content">
                              ...
                              <p>
                                  Earn free bitcoins in rewards by completing a learning mission daily or inviting
                                  friends to Qash.
                                  <a href="#">Learn more</a>
                              </p>
              ...
              <div class="col-xxl-8 col-xl-8">
                  <div class="card dashboard-select">
                      <div class="card-header">
                          ...
                          <select class="form-select d-none" name="report-type" id="report-select">
